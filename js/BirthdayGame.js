...
let won = document.getElementById("welcomePrincess");

won.addEventListener('mouseover',last);

function wait() {
    window.location.href='../html/BirthdayFinal.html';
}


function last(){
    const myTimeout = setTimeout(wait, 500);
}
